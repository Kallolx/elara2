  ...
  return (
    <div className="space-y-6">
      <header className="flex items-center justify-between gap-4">
        ...
        <h2 className="text-xl font-semibold tracking-[-0.03em] text-foreground">Add category</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <section className="border border-line bg-surface px-5 py-5">
          ...
          <span className="mt-2 block text-xs text-text-soft leading-6">
            Define the subcategories belonging to this category (e.g. Foam Cleansers, Oil Cleansers). They will automatically appear as options in the product dropdown.
          </span>
            ...
            {subcategories.map((value, index) => (
              <div key={index} className="flex items-start gap-3">
                ...
                <input
                  ...
                  placeholder="Subcategory name (e.g. Foam Cleansers)"
                  className="w-full border border-line bg-background px-4 py-3 text-foreground outline-none focus:border-accent"
                />
                <Button
                  type="button"
