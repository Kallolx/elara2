...
import { FiEye, FiEyeOff, FiLock, FiMail, FiUser, FiSliders, FiLoader } from "react-icons/fi";
        ...
        <div className="w-full max-w-md space-y-8 border border-line bg-surface p-8 sm:p-10 shadow-sm">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-text-soft">
              Join Elara and configure your skincare dashboard.
            </p>
          </div>
          ...
          <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
            <div className="space-y-4">
              <div>
                <label htmlFor="fullname-input" className="block text-xs uppercase tracking-[0.2em] text-text-soft font-semibold">
                  Full Name
                </label>
